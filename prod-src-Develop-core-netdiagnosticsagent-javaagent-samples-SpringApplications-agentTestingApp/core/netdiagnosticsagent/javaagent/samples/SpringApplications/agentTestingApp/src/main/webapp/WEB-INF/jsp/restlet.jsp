...
<title>Spring Boot : RESTLET</title>
</head>
<body>
	...
	<ul>
		...
		<li><a class="active" href="restlet">RESTLET</a></li>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 500px;">
		...
		<form class="myForm" method="post"
			enctype="application/x-www-form-urlencoded" action="restletcallout">

			<fieldset>
				<legend>Restlet Service</legend>

				<p>* Host : localhost *</p>

				<p>
					<label class="choice"> <input type="radio" name="client"
						value="resletServer" checked="checked"> Start Restlet
						Server
				...
				<p>
					<label class="choice"> <input type="radio" name="client"
						value="resletClient"> Run Restlet Client

					</label>
				</p>
			</fieldset>
			<p>
				<label>Port </label><input type="text" name="port" value="6680"
					required>
			</p>
