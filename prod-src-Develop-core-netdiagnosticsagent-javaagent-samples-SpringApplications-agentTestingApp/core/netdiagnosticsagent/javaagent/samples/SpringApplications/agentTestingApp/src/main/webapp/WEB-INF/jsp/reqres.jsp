...
<title>Spring Boot : REQUEST RESPONSE DUMP</title>
</head>
<body>
	...
	<ul>
		...
		<li><a class="active" href="reqres">REQUEST RESPONSE DUMP</a></li>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 500px;">
		...
		<form class="myForm" method="get"
			...
			action="/reqres/getEmployee">

			<fieldset>
				<legend>Request Response Services</legend>
				<p>Response in XML
				<p>
					<button>GET</button>
				</p>
				<p>Use Postman Tool :</p>
				<p>/reqres/saveEmployee -----> XML request response</p>

				<p>/reqres/setEmployee -----> JSON request response</p>

				<p>/reqres/sendEmployee -----> plain text response</p>
			</fieldset>
